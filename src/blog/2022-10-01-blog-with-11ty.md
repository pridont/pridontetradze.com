...
date: 2022-10-01
image: "/assets/images/11ty-thumbnail.webp"
...
```html src/_includes/post-preview.njk
<li class="blog-preview">
  <img src="{{ post.data.image }}" alt="{{ post.data.imageAlt }}" />
  <div class="blog-preview__details">
    <div>
...
```html src/_includes/og-tags.njk
